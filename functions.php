...
// Add an Admin Notice on Eli Theme activation.
...
function my_theme_activation_notice(){
    ...
    <div class="notice notice-info is-dismissible">
        <p>Thank you for activating eli. <strong>Let's Get Started</strong>. <a href="<?php echo admin_url("themes.php?page=theme-settings"); ?>">Click Here</a>.</p>
    </div>
    <?php
}

// Add an eli options page in the WP Dashboard > Appearances tab.
